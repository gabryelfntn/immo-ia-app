...
export function FollowupModal(props: Props) {
  ...
  return (
    ...
    >
      <div className="w-full max-w-3xl overflow-hidden rounded-2xl border border-gray-200 bg-gradient-to-b from-white via-gray-50 to-slate-100 shadow-[0_0_80px_-30px_rgba(99,102,241,0.35)]">
        <div className="flex items-center justify-between border-b border-gray-100 px-6 py-5">
          ...
          <button
            type="button"
            onClick={onClose}
            className="rounded-xl border border-gray-200 bg-gray-50 p-2 text-zinc-400 transition-colors hover:border-gray-300 hover:text-gray-800"
            aria-label="Fermer"
          >
            <X className="h-5 w-5" />
          </button>
        ...
        <div className="px-6 py-6 sm:px-8">
          {loading ? (
            <div className="flex flex-col items-center justify-center rounded-2xl border border-gray-200 bg-black/20 py-16">
              <span
            ...
            <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-gray-200 bg-white/[0.02] px-6 py-14 text-center">
            ...
            <div className="space-y-6">
              <div className="rounded-2xl border border-gray-200 bg-black/20 p-5">
        ...
        <div className="flex flex-col gap-3 border-t border-gray-100 px-6 py-5 sm:flex-row sm:items-center sm:justify-between sm:px-8">
          <button
            ...
            className="inline-flex items-center justify-center gap-2 rounded-xl border border-gray-200 bg-gray-50 px-5 py-3 text-sm font-semibold text-gray-800 transition-all hover:border-gray-300 hover:bg-gray-100 disabled:cursor-not-allowed disabled:opacity-40"
          >
            {copied ? (
