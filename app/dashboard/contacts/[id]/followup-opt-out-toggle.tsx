    ...
    <div className="rounded-2xl border border-slate-200/90 bg-white p-5 card-luxury">
      ...
      <label className="mt-4 flex cursor-pointer items-start gap-3">
        <input
          ...
          className="mt-0.5 h-5 w-5 shrink-0 rounded-md border border-white/20 bg-slate-50 text-rose-500 shadow-[0_0_12px_-4px_rgba(244,63,94,0.35)] focus:ring-2 focus:ring-rose-500/30 focus:ring-offset-0 disabled:opacity-50"
        />
