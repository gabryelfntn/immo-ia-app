...
export function PropertyGallery({
  ...
  const placeholderHero = (
    <div className="flex h-full w-full flex-col items-center justify-center bg-gradient-to-br from-slate-100 to-slate-200/90">
      <span className="text-6xl opacity-40" aria-hidden>
        🏠
      </span>
      <p className="mt-4 text-sm font-medium text-slate-500">Aucune photo</p>
    </div>
  );
  ...
  if (hero) {
    ...
    return (
      <div className="overflow-hidden rounded-2xl border border-slate-200/90 bg-white shadow-2xl shadow-black/60 card-luxury">
        ...
        {slides.length > 1 ? (
          <div className="border-t border-slate-100 bg-slate-50/95 px-4 py-3">
            <ul
