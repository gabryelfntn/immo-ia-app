...
export async function GET() {
  ...
  let q = supabase
    .from("contacts")
    .select(
      "id, first_name, last_name, email, phone, type, status, source, budget_min, budget_max, desired_city, pipeline_stage, created_at, updated_at, next_action_at, next_action_label"
    )
